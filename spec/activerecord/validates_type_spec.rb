...
describe 'ValidatesType' do
  context 'supported types' do
    ...
    describe 'Integer' do
      ...
      subject { TypeValidationTest.set_accessor_and_validator(:integer) }
    ...
    describe 'Float' do
      ...
      subject { TypeValidationTest.set_accessor_and_validator(:float) }
    ...
    describe 'Boolean' do
      ...
      subject { TypeValidationTest.set_accessor_and_validator(:boolean) }
    ...
    describe 'Hash' do
      ...
      subject { TypeValidationTest.set_accessor_and_validator(:hash) }
    ...
    describe 'Array' do
      ...
      subject { TypeValidationTest.set_accessor_and_validator(:array) }
    ...
    describe 'Symbol' do
      ...
      subject { TypeValidationTest.set_accessor_and_validator(:symbol) }
  ...
  context 'unsupported types' do
    describe 'Foo' do
      specify do
        expect do
          subject = TypeValidationTest.set_accessor_and_validator(:foo)
          subject.valid?
        end.to raise_error(
